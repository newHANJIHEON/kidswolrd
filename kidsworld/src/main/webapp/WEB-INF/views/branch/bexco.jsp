...
<head>
    ...
    <style>
        ...
        #backgroundImg{
            ...
            height: 1150px;
            top: 850px;
            background-image: url("${path}/resources/img/background_img/background2.jpg");
...
<section class="banner_section">
    <div>
        ...
        <span class="subbanner_title_text">부산 벡스코</span>
        <span class="subbanner_title_text2">.Busan Bexco</span>
    </div>
</section>
