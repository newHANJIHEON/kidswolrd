...
<section class="banner_section">
    <div>
        ...
        <span class="subbanner_title_text">질 의 응 답 쓰 기</span>
        <span class="subbanner_title_text2">.QnA write</span>
    </div>
</section>
...
<div id="qnawrite_wrapwrap">
    <sec:authorize access="isAuthenticated()">
        ...
        <form action="${path}/community/qnaWriteSubmit" method="post">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <input type="hidden" name="qUserNum" value="${loginMember.uNum}" />
            <table id="qnawrite_wrap">
                <tr>
                    <td class="box1 title_box">제목</td>
                    <td class="box2 title_box">
                        <input class="subbox1" type="text" name="qTitle" />
                    </td>
                </tr>
                <tr>
                    <td class="box1">작성자</td>
                    <td class="box2">
                        <input class="subbox1" type="text" name="qWriter" value="${loginMember.uName}" readonly />
                    </td>
                </tr>
                <tr>
                    <td class="box1">내용</td>
