...
<section class="banner_section">
    <div>
        ...
        <span class="subbanner_title_text">리 뷰 쓰 기</span>
        <span class="subbanner_title_text2">.review write</span>
    </div>
</section>
...
<div id="noticewrite_wrapwrap">
    <sec:authorize access="isAuthenticated()">
        ...
        <form action="${path}/community/reviewWriteSubmit" method="post">
            ...
            <table id="noticewrite_wrap">
                <tr>
                    ...
                    <td class="box2 title_box">
                        <input class="subbox1" type="text" name="rTitle" />
                    </td>
                </tr>
                <tr>
                    <td class="box1">별점</td>
                ...
                <tr>
                    ...
                    <td class="box2">
                        <input class="subbox1" type="text" name="rWriter" value="${loginMember.uName}" />
                    </td>
                </tr>
                <tr>
                    <td class="box1">내용</td>
                    <td class="box2">
                        <textarea name="rContent" id="editor"></textarea>
                    </td>
                </tr>
            </table>
