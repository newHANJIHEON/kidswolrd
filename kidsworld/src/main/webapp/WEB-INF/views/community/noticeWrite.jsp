...
<section class="banner_section">
    <div>
        ...
        <span class="subbanner_title_text">공 지 사 항 쓰 기</span>
        <span class="subbanner_title_text2">.notice write</span>
    </div>
</section>
...
<div id="noticewrite_wrapwrap">
    <sec:authorize access="hasRole('ROLE_MASTER')">
        ...
        <form action="${path}/community/noticeWriteSubmit" method="post">
            ...
            <table id="noticewrite_wrap">
                <tr>
                    ...
                    <td class="box2 title_box">
                        <input class="subbox1" type="text" name="nTitle" />
                    </td>
                </tr>
                <tr>
                    <td class="box1">카테고리</td>
                    <td class="box2">
                        <select class="subbox2" name="nCategory">
                ...
                <tr>
                    ...
                    <td class="box2">
                        <input class="subbox1" type="text" name="nWriter" value="${loginMember.uName}" />
                    </td>
                </tr>
                <tr>
                    <td class="box1">내용</td>
